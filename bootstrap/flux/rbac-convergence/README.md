...
This one-time executable authorizes exactly platform tag `v0.1.20`, the next
release after its reviewed `v0.1.19` protected base. `target.json` cannot select
...
- `releaseTag`: exactly `v0.1.20`, whose immutable platform Release targets the
