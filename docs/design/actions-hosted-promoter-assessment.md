...
writes. The workstation design in issue #286 should remain the supported path
until every condition below is enforced and the owner explicitly accepts the
