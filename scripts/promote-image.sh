...
declare -a release_state_paths=(
  ...
  'infrastructure/cloudflare/phases/site-lidersea-com/.terraform.lock.hcl'
  'infrastructure/cloudflare/phases/site-lidersea-com/main.tf'
  'infrastructure/cloudflare/phases/site-lidersea-com/terraform.tfvars.example'
  'infrastructure/cloudflare/phases/site-lidersea-com/variables.tf'
  'infrastructure/cloudflare/phases/site-lidersea-com/versions.tf'
  'infrastructure/cloudflare/phases/site-naranjo-online/.terraform.lock.hcl'
  'infrastructure/cloudflare/phases/site-naranjo-online/main.tf'
  'infrastructure/cloudflare/phases/site-naranjo-online/terraform.tfvars.example'
  'infrastructure/cloudflare/phases/site-naranjo-online/variables.tf'
  'infrastructure/cloudflare/phases/site-naranjo-online/versions.tf'
)
