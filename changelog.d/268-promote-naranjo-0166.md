...
- Advance naranjo.online's exact signed chart selection to its published
  release `0.1.66` (carrying releases `v0.1.64` through `v0.1.66` to the
  domain, headlined by the full-width phone rendering repair of
  naranjo.online issue #264 / PR #269) by re-resolving the reviewed tag,
  verifying the repository-at-digest against the site's
