variable "enable_public_dns_lidersea_activation" {
  description = "Explicit final lidersea.com DNS acknowledgement; false fails planning without changing resource identity."
  type        = bool
  default     = false
}
