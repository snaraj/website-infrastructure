...
class PrivilegedProcessBoundaryTests(unittest.TestCase):
    ...
    def test_source_manifest_is_exact_historical_v040_bundle(self):
        expected_modes = {
            ...
            "changelog.d/141-flux-rbac-v040-live-drift.md": 0o600,
    ...
    def test_v040_uses_fresh_versioned_state_root(self):
        expected = Path(
...
class ReleaseOrderingTests(unittest.TestCase):
    ...
    def test_only_reviewed_one_time_release_tag_reaches_public_reads(self):
        self.assertEqual(transaction.AUTHORIZED_RELEASE_TAG, "v0.1.40")
        for rejected in (
            "v0.1.0",
            "v0.1.21",
            "v0.1.22",
