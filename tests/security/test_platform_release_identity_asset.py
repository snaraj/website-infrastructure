...
class PlatformReleaseIdentityAssetTests(unittest.TestCase):
    ...
    def test_receipt_derives_exact_current_site_identities(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "layer_digest": (
                    "sha256:08477ad37eb7a9c4d0f46b32"
                    "627e302ad7a8a6df2f9c22b0c"
                    "98d06d6208b031a"
                ),
                "manifest_digest": (
                    "sha256:b994ee431bd35c76d3fa49f2"
                    "92b3452b68006e3c8530095a2"
                    "fc6cc14f43fa6f4"
                ),
        ...
        self.assertEqual(
            ...
            {
                "arm64_digest": (
                    "sha256:5169b6c1386a6f2327e8c766"
                    "0c084742dead700efa4e588d"
                    "525a4f69da1e830e"
                ),
                "image": (
                    "ghcr.io/snaraj/naranjo-online:v0.1.67@"
                    "sha256:0bc97e1a2b87acf21b3dcc6"
                    "ce8b3c0dd1b15bbd205a69cc"
                    "5ec0dae2f1cdb7504"
                ),
            },
        )
