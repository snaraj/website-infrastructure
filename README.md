...
| Flux site desired state | Combined #195/#189 candidate: both manifests are unsuspended at the exact currently healthy signed chart digests (naranjo `0.1.53`, lidersea `0.1.37`) behind one exact-tag source and two direct `prune: false`, `deletionPolicy: Orphan` reconcilers; no live equivalence, readiness, or traffic is claimed |
